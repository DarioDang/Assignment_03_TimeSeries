...
Similar to what we have discuss, auto arima also suggest the ARMA(0,2) with have the lowest AIC (681.22) emphasize that ARMA(2,2) seem to be an adequate model for this series. However, to make it more clear, we try to with different ARMA model and look for the lowest AIC.
