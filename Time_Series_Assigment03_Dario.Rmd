...
Lastly, let's compare AICs of all the possible models with $0 \leq p \leq 3$ and $0 \leq q \leq 3$ as another method to determine whether ARMA(0,1) was ultimately a good fit.
...
Excluding Auto_Arima, ARMA(0,1) had the third lowest AIC. Surprisingly, ARMA(0,2) and ARMA(1,1) had better AIC terms.
