...
Use the library quantmod to extract the daily time series of the share prices of the Burberry Group by using the command `getSymbols("BB2.BE",from="2015-01-01",to="2024-08-31")`, extract the adjusted price and plot it.
...
::: boxTask
What is an adequate ARMA model for the adjusted price? Produce a tsdiag for the chosen model with comment.
:::
...
::: boxTask
Use the xts library to transoform the daily adjusted prices from the previous question to a monthly close series and plot it.
:::
